...
const KNOWN_TOKEN =
  /\b(?:gh[pousr]_[A-Za-z0-9_]+|github_pat_[A-Za-z0-9_]+|npm_[A-Za-z0-9]+|AKIA[0-9A-Z]{16}|sk-[A-Za-z0-9_-]{16,})\b/g;
const CREDENTIAL_URL = /(\b[a-z][a-z\d+.-]*:\/\/)([^\s/:@]+):([^\s/@]+)@/gi;
const SECRET_ASSIGNMENT =
  /((?:^|[\s;&|])(?:[A-Za-z0-9_]*(?:TOKEN|SECRET|PASSWORD|PASSWD|PRIVATE_KEY|API_KEY)[A-Za-z0-9_]*)(?:\s*[:=]\s*))("[^"]*"|'[^']*'|[^\s;&|]+)/gi;
